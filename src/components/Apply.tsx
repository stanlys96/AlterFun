...
export default function Apply({ onNavigate }: ApplyProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.youtubeLink && !formData.twitchLink && !formData.twitterLink) {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed max-w-2xl mx-auto">
            We're excited you're interested! Just fill out the form below. Our team will manually review it to ensure every creator on Alterfun is real and active.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="bg-gray-50 rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">1. Contact Info</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  We'll only use this email to notify you about your application status. No spam, ever.
                </p>
              </div>
          ...
          <div className="bg-gray-50 rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">2. Your Channel Links</h2>
            <p className="text-gray-700 mb-6">
              Please copy-paste the links to your main channels. Our team will check these links to verify your activity.
            </p>
          ...
          <div className="bg-gray-50 rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">3. Profile Info</h2>
            <p className="text-gray-700 mb-6">
              We'll use this info for your public profile page if you're approved. (You can change all of this later).
            </p>
          ...
          <div className="bg-gray-50 rounded-xl p-8 shadow-sm">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">4. Submit Application</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="terms" className="text-sm text-gray-700">
                  ...
                  <a href="/terms" className="text-[#7E34FF] hover:underline font-semibold">
